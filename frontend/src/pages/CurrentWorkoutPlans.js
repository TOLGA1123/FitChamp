    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ backgroundColor: green[500] }}>
        ...
        >
          ...
          <Tab label="Progress" value="progress" sx={{ color: 'white', backgroundColor: 'black' }} />
        </Tabs>
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0 10px', height: '60px' }}>
          ...
          <IconButton sx={{ position: 'absolute', right: 16 }} onClick={handleProfileClick}><FitnessCenterIcon /></IconButton>
        </Box>
      </AppBar>
