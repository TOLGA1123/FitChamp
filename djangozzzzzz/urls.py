...
urlpatterns = [
    ...
    path('group-sessions/',GroupSessionView.as_view(),name='group-sessions'),
    path('create-session/',CreateGroupSessionView.as_view(),name='group-sessions'),
    path('trainee-group-sessions/', GroupSessionsView.as_view(), name='group-sessions'),
